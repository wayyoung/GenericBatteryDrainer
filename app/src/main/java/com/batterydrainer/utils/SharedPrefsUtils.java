package com.batterydrainer.utils;
...
import com.batterydrainer.ui.SettingsDialogFragment;
...
public class SharedPrefsUtils {
    ...
    public static boolean[] getSwitchStates(Context context) {
        ...
        switchStates[3] = sharedPreferences.getBoolean(DrainForegroundService.KEY_GPU, true);
